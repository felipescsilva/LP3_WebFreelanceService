...
public class User01 {
	...
	public User01(String id, String name, String email, String color) {
		super();
		setId(id);
		setName(name);
		setEmail(email);
	...
	public User01(long id, String name, String email, String color) {
		super();
		setId(id);
		setName(name);
		setEmail(email);
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof User01)) {
			return false;
		}
		User01 other = (User01) obj;
